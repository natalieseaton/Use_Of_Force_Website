---
title: "Iraq Regime Change Crisis"
...
downloadHandler(
  filename = function() { 
    paste("Iraq_2002_Regime_Change",".csv", sep = "")
  }, 
  content = function(file) {
    write.csv(Sheet, file)
  },
  outputArgs = list(label = "Iraq_2002_Regime_Change (.csv) ")
)
...
trend_sheet  <- read_sheet("https://docs.google.com/spreadsheets/d/1lEf0kQi8LLfC8xExB3iGnMiEBcct0Dkq6D-sHj055SI/edit?usp=sharing")
